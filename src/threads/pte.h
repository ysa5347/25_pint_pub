...
#define PTE_P 0x1               /* 001,       1=present, 0=not present. */
#define PTE_W 0x2               /* 010,       1=read/write, 0=read-only. */
#define PTE_U 0x4               /* 100,       1=user/kernel, 0=kernel only. */
#define PTE_A 0x20              /* 0010 0000, 1=accessed, 0=not acccessed. */
#define PTE_D 0x40              /* 0100 0000, 1=dirty, 0=not dirty (PTEs only). */
